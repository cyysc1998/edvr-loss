...
def train(args):
    ...
    MODEL_PATH = '/home/sunchao/test/ConsNet/checkpoints/exp_single_chamfer_0.0004/best_exp_single_chamfer_0.0004.pkl'
    ...
    for epoch in range(args.epochs):
        ...
        for i, point in enumerate(train_loader):
            ...
            print('diff: ', chamfer_distance(pred1, pred2) + chamfer_distance(pred2, pred1))
            print('sim', chamfer_distance(pred1, data1) + chamfer_distance(data1, pred1))
